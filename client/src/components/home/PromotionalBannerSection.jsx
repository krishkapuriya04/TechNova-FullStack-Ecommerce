  ...
  return (
    <section className="tn-container tn-section-y">
      <motion.div
        ...
        className="relative overflow-hidden rounded-tn-2xl border border-sky-500/20 bg-gradient-to-r from-slate-900 via-sky-900 to-slate-950 p-[1px] shadow-tn-card dark:shadow-tn-glow-sm"
      >
        <div className="relative flex flex-col gap-6 rounded-tn-2xl bg-tn-950/90 px-6 py-10 backdrop-blur-xl sm:flex-row sm:items-center sm:justify-between sm:px-10">
          ...
          <div className="relative max-w-xl space-y-3">
            ...
            <p className="text-sm text-sky-100/90">{promoBanner.subtitle}</p>
          </div>
          <div className="relative shrink-0">
            <Link
              to={promoBanner.cta.to}
              className="inline-flex items-center justify-center rounded-tn bg-white px-5 py-2.5 text-sm font-semibold text-sky-700 shadow-lg tn-transition-base hover:brightness-105 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
            >
