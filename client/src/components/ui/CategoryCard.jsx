...
export function CategoryCard({ category }) {
  ...
  return (
    ...
    >
      <Link
        to={category.to}
        className="tn-surface group relative block overflow-hidden rounded-tn-xl p-6 tn-glow-ring tn-transition-base hover:border-sky-300/50 dark:hover:border-sky-400/30"
      >
        <div
