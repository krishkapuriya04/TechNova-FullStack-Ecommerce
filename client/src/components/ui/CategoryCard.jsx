...
export function CategoryCard({ category }) {
  ...
  return (
    ...
    >
      <Link
        to={category.to}
        className="tn-surface group relative block overflow-hidden rounded-tn-xl p-6 tn-glow-ring tn-transition-base hover:border-teal-400/45 dark:hover:border-teal-400/30"
      >
        <div
